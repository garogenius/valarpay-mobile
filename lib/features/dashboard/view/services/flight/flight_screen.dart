...
class _FlightScreenState extends ConsumerState<FlightScreen> {
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    _buildPassengerCounter('Adults (12+ years)', adults, (
                      value,
                    ) {
                      setState(() => adults = value);
                    }, isDark),
                    const SizedBox(height: 12),
                    _buildPassengerCounter('Children (2-11 years)', children, (
                      value,
                    ) {
                      setState(() => children = value);
                    }, isDark),
                    const SizedBox(height: 12),
                    _buildPassengerCounter('Infants (under 2 years)', infants, (
                      value,
                    ) {
  ...
  void _showDestinationSelector(BuildContext context, bool isDeparture) {
    showModalBottomSheet(
      ...
      builder:
          (context) => DestinationSelectorModal(
