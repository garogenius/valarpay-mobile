...
import 'package:valarpay/features/dashboard/widgets/services_widgets/international_airtime_widgets/plan_selector_modal.dart';
import 'package:valarpay/features/notifiers/airtime_notifier.dart';
import 'package:valarpay/features/models/airtime_models.dart';
import 'package:valarpay/core/utils/currency_formatter.dart';
import 'package:valarpay/core/widgets/all_time_reusable_button.dart';
...
class _CountryProviderScreenState extends ConsumerState<CountryProviderScreen> {
  ...
  void _showPlanSelector(BuildContext context) {
    showModalBottomSheet(
      ...
      builder:
          (context) => PlanSelectorModal(
            selectedPlan: selectedPlan,
            onPlanSelected: (plan, rate) {
              setState(() {
                selectedPlan = plan;
                selectedRate = rate;
              });
